...
#define DEFINEMACRO(ret, func, args, argscall)                                 \
  static inline ret _goboringcrypto_##func args { return func argscall; }

static void *handle;
static void *_goboringcrypto_DLOPEN_OPENSSL(void) {
  if (handle) {
    return handle;
  }
...
static void _goboringcrypto_OPENSSL_setup(void) {
...
_goboringcrypto_internal_ERR_get_error_all(const char **file, int *line,
                                           const char **func, const char **data,
                                           int *flags) {
  unsigned long e =
      _goboringcrypto_internal_ERR_get_error_line_data(file, line, data, flags);
  if (e == 0 && func != NULL) {
    *func = "unknown";
  }
  return e;
...
#endif
DEFINEFUNCINTERNAL(void, ERR_error_string_n,
                   (unsigned long e, unsigned char *buf, size_t len),
                   (e, buf, len))
...
#else
static inline int _goboringcrypto_CRYPTO_num_locks(void) {
  return CRYPTO_num_locks(); /* defined as macro */
}
#endif
#if OPENSSL_VERSION_NUMBER < 0x10100000L
DEFINEFUNC(void, CRYPTO_set_id_callback, (unsigned long (*id_function)(void)),
           (id_function))
#else
static inline void
...
DEFINEFUNC(void, CRYPTO_set_locking_callback,
           (void (*locking_function)(int mode, int n, const char *file,
                                     int line)),
           (locking_function))
#else
static inline void _goboringcrypto_CRYPTO_set_locking_callback(
...
#else
DEFINEFUNC(int, EVP_default_properties_is_fips_enabled, (OSSL_LIB_CTX * libctx),
           (libctx))
...
DEFINEFUNC(int, SHA1_Update, (GO_SHA_CTX * arg0, const void *arg1, size_t arg2),
           (arg0, arg1, arg2))
...
DEFINEFUNC(int, SHA224_Update,
           (GO_SHA256_CTX * arg0, const void *arg1, size_t arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, SHA224_Final, (uint8_t * arg0, GO_SHA256_CTX *arg1),
           (arg0, arg1))

DEFINEFUNC(int, SHA256_Init, (GO_SHA256_CTX * arg0), (arg0))
DEFINEFUNC(int, SHA256_Update,
           (GO_SHA256_CTX * arg0, const void *arg1, size_t arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, SHA256_Final, (uint8_t * arg0, GO_SHA256_CTX *arg1),
           (arg0, arg1))

typedef SHA512_CTX GO_SHA512_CTX;
DEFINEFUNC(int, SHA384_Init, (GO_SHA512_CTX * arg0), (arg0))
DEFINEFUNC(int, SHA384_Update,
           (GO_SHA512_CTX * arg0, const void *arg1, size_t arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, SHA384_Final, (uint8_t * arg0, GO_SHA512_CTX *arg1),
           (arg0, arg1))

DEFINEFUNC(int, SHA512_Init, (GO_SHA512_CTX * arg0), (arg0))
DEFINEFUNC(int, SHA512_Update,
           (GO_SHA512_CTX * arg0, const void *arg1, size_t arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, SHA512_Final, (uint8_t * arg0, GO_SHA512_CTX *arg1),
           (arg0, arg1))
...
static inline int _goboringcrypto_EVP_MD_get_size(const GO_EVP_MD *arg0) {
...
DEFINEFUNCINTERNAL(int, MD5_Update, (MD5_CTX * c, const void *data, size_t len),
                   (c, data, len))
DEFINEFUNCINTERNAL(int, MD5_Final, (unsigned char *md, MD5_CTX *c), (md, c))

static inline int _goboringcrypto_EVP_MD_type(const GO_EVP_MD *md) {
#if OPENSSL_VERSION_NUMBER < 0x30000000L
...
static inline const GO_EVP_MD *_goboringcrypto_EVP_md5_sha1(void) {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
...
DEFINEFUNC(int, HMAC_Init_ex,
           (GO_HMAC_CTX * arg0, const void *arg1, int arg2,
            const GO_EVP_MD *arg3, ENGINE *arg4),
           (arg0, arg1, arg2, arg3, arg4))
DEFINEFUNC(int, HMAC_Update,
           (GO_HMAC_CTX * arg0, const uint8_t *arg1, size_t arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, HMAC_Final,
           (GO_HMAC_CTX * arg0, uint8_t *arg1, unsigned int *arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(size_t, HMAC_CTX_copy, (GO_HMAC_CTX * dest, GO_HMAC_CTX *src),
           (dest, src))

#if OPENSSL_VERSION_NUMBER < 0x10100000L
DEFINEFUNCINTERNAL(void, HMAC_CTX_cleanup, (GO_HMAC_CTX * arg0), (arg0))
static inline void _goboringcrypto_HMAC_CTX_free(HMAC_CTX *ctx) {
  if (ctx != NULL) {
...
#if OPENSSL_VERSION_NUMBER < 0x10100000L
static inline size_t _goboringcrypto_HMAC_size(const GO_HMAC_CTX *arg0) {
  return _goboringcrypto_EVP_MD_get_size(arg0->md);
}
#else
DEFINEFUNCINTERNAL(const EVP_MD *, HMAC_CTX_get_md, (const GO_HMAC_CTX *ctx),
                   (ctx))
static inline size_t _goboringcrypto_HMAC_size(const GO_HMAC_CTX *arg0) {
  const EVP_MD *md;
...
static inline GO_HMAC_CTX *_goboringcrypto_HMAC_CTX_new(void) {
...
#if OPENSSL_VERSION_NUMBER < 0x10100000L
static inline int _goboringcrypto_HMAC_CTX_reset(GO_HMAC_CTX *ctx) {
  _goboringcrypto_internal_HMAC_CTX_cleanup(ctx);
  _goboringcrypto_internal_HMAC_CTX_init(ctx);
  return 0;
}
...
DEFINEFUNC(int, EVP_CIPHER_CTX_set_padding, (EVP_CIPHER_CTX * x, int padding),
           (x, padding))
...
int _goboringcrypto_EVP_AES_encrypt(EVP_CIPHER_CTX *ctx, const uint8_t *in,
                                    size_t in_len, uint8_t *out);

enum { GO_AES_ENCRYPT = 1, GO_AES_DECRYPT = 0 };
void _goboringcrypto_EVP_AES_cbc_encrypt(EVP_CIPHER_CTX *ctx,
                                         const uint8_t *arg0, uint8_t *arg1,
                                         size_t arg2, const uint8_t *a,
                                         const int arg5);
...
void EVP_AES_cbc_enc(EVP_CIPHER_CTX *ctx, const uint8_t *in, uint8_t *out,
                     size_t len);

void EVP_AES_cbc_dec(EVP_CIPHER_CTX *ctx, const uint8_t *in, uint8_t *out,
                     size_t len);
...
DEFINEFUNC(GO_BIGNUM *, BN_bin2bn,
           (const uint8_t *arg0, size_t arg1, GO_BIGNUM *arg2),
           (arg0, arg1, arg2))

static inline int _goboringcrypto_BN_num_bytes(const GO_BIGNUM *a) {
  return ((_goboringcrypto_BN_num_bits(a) + 7) / 8);
}

#if OPENSSL_VERSION_NUMBER >= 0x10100000L
DEFINEFUNC(GO_BIGNUM *, BN_lebin2bn,
           (const unsigned char *s, size_t len, GO_BIGNUM *ret), (s, len, ret))
DEFINEFUNC(int, BN_bn2lebinpad,
           (const GO_BIGNUM *a, unsigned char *to, size_t tolen),
           (a, to, tolen))
DEFINEFUNC(int, BN_bn2binpad,
           (const GO_BIGNUM *a, unsigned char *to, int tolen), (a, to, tolen))
#else
DEFINEFUNCINTERNAL(int, BN_bn2bin, (const GO_BIGNUM *a, unsigned char *to),
                   (a, to))

static inline GO_BIGNUM *_goboringcrypto_BN_lebin2bn(const unsigned char *s,
                                                     size_t len,
                                                     GO_BIGNUM *ret) {
  unsigned char *copy;
  size_t i;
...
static inline int _goboringcrypto_BN_bn2binpad(const GO_BIGNUM *a,
                                               unsigned char *to,
                                               size_t tolen) {
...
static inline int _goboringcrypto_BN_bn2lebinpad(const GO_BIGNUM *a,
                                                 unsigned char *to,
                                                 size_t tolen) {
...
DEFINEFUNC(int, EC_POINT_get_affine_coordinates_GFp,
           (const GO_EC_GROUP *arg0, const GO_EC_POINT *arg1, GO_BIGNUM *arg2,
            GO_BIGNUM *arg3, GO_BN_CTX *arg4),
           (arg0, arg1, arg2, arg3, arg4))
DEFINEFUNC(int, EC_POINT_set_affine_coordinates_GFp,
           (const GO_EC_GROUP *arg0, GO_EC_POINT *arg1, const GO_BIGNUM *arg2,
            const GO_BIGNUM *arg3, GO_BN_CTX *arg4),
           (arg0, arg1, arg2, arg3, arg4))
...
DEFINEFUNC(const GO_EC_GROUP *, EC_KEY_get0_group, (const GO_EC_KEY *arg0),
           (arg0))
DEFINEFUNC(int, EC_KEY_set_group, (GO_EC_KEY * arg0, const EC_GROUP *arg1),
           (arg0, arg1))
DEFINEFUNC(int, EC_KEY_generate_key, (GO_EC_KEY * arg0), (arg0))
DEFINEFUNC(int, EC_KEY_set_private_key,
           (GO_EC_KEY * arg0, const GO_BIGNUM *arg1), (arg0, arg1))
DEFINEFUNC(int, EC_KEY_set_public_key,
           (GO_EC_KEY * arg0, const GO_EC_POINT *arg1), (arg0, arg1))
DEFINEFUNC(const GO_BIGNUM *, EC_KEY_get0_private_key, (const GO_EC_KEY *arg0),
           (arg0))
DEFINEFUNC(const GO_EC_POINT *, EC_KEY_get0_public_key, (const GO_EC_KEY *arg0),
           (arg0))

#if OPENSSL_VERSION_NUMBER >= 0x10100000L
DEFINEFUNC(int, EC_KEY_oct2key,
           (GO_EC_KEY * arg0, const unsigned char *arg1, size_t arg2,
            BN_CTX *arg3),
           (arg0, arg1, arg2, arg3))
#else
DEFINEFUNCINTERNAL(int, EC_POINT_oct2point,
                   (const EC_GROUP *arg0, EC_POINT *arg1,
                    const unsigned char *arg2, size_t arg3, BN_CTX *arg4),
                   (arg0, arg1, arg2, arg3, arg4))

static inline int _goboringcrypto_EC_KEY_oct2key(GO_EC_KEY *eckey,
  ...
  if (_goboringcrypto_internal_EC_POINT_oct2point(group, pubkey, buf, len,
                                                  ctx) != 1 ||
...
DEFINEFUNC(GO_ECDSA_SIG *, ECDSA_do_sign,
           (const uint8_t *arg0, size_t arg1, const GO_EC_KEY *arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, ECDSA_do_verify,
           (const uint8_t *arg0, size_t arg1, const GO_ECDSA_SIG *arg2,
            GO_EC_KEY *arg3),
           (arg0, arg1, arg2, arg3))
DEFINEFUNC(size_t, ECDSA_size, (const GO_EC_KEY *arg0), (arg0))

DEFINEFUNCINTERNAL(int, ECDSA_sign,
                   (int type, const unsigned char *dgst, size_t dgstlen,
...
static inline int _goboringcrypto_EVP_PKEY_assign_EC_KEY(EVP_PKEY *pkey,
                                                         GO_EC_KEY *eckey) {
  return _goboringcrypto_internal_EVP_PKEY_assign(pkey, EVP_PKEY_EC,
                                                  (char *)(eckey));
}

static inline int _goboringcrypto_EVP_PKEY_assign_RSA(EVP_PKEY *pkey,
                                                      RSA *rsa) {
  return _goboringcrypto_internal_EVP_PKEY_assign(pkey, EVP_PKEY_RSA,
                                                  (char *)(rsa));
}

DEFINEFUNC(int, EVP_DigestSignInit,
           (EVP_MD_CTX * ctx, EVP_PKEY_CTX **pctx, const EVP_MD *type,
            ENGINE *e, EVP_PKEY *pkey),
           (ctx, pctx, type, e, pkey))

DEFINEFUNC(int, EVP_DigestUpdate, (EVP_MD_CTX * ctx, const void *d, size_t cnt),
           (ctx, d, cnt))
...
int _goboringcrypto_EVP_sign(EVP_MD *md, EVP_PKEY_CTX *ctx, const uint8_t *msg,
                             ...
                             EVP_PKEY *eckey);
int _goboringcrypto_EVP_sign_raw(EVP_MD *md, EVP_PKEY_CTX *ctx,
                                 const uint8_t *msg, size_t msgLen,
                                 uint8_t *sig, size_t *slen, GO_RSA *key);
...
int _goboringcrypto_ECDSA_sign(EVP_MD *md, const uint8_t *arg1, size_t arg2,
                               uint8_t *arg3, size_t *arg4, GO_EC_KEY *arg5);
int _goboringcrypto_ECDSA_verify(EVP_MD *md, const uint8_t *arg1, size_t arg2,
                                 const uint8_t *arg3, unsigned int arg4,
                                 GO_EC_KEY *arg5);
...
DEFINEFUNC(int, RSA_sign,
           (int arg0, const uint8_t *arg1, unsigned int arg2, uint8_t *arg3,
            unsigned int *arg4, GO_RSA *arg5),
           (arg0, arg1, arg2, arg3, arg4, arg5))
DEFINEFUNC(int, RSA_verify,
           (int arg0, const uint8_t *arg1, unsigned int arg2,
            const uint8_t *arg3, unsigned int arg4, GO_RSA *arg5),
           (arg0, arg1, arg2, arg3, arg4, arg5))
...
DEFINEFUNCINTERNAL(int, RSA_set0_factors,
                   (GO_RSA * rsa, GO_BIGNUM *p, GO_BIGNUM *q), (rsa, p, q))

static inline int _goboringcrypto_RSA_set0_factors(GO_RSA *r, GO_BIGNUM *p,
                                                   GO_BIGNUM *q) {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
...
DEFINEFUNCINTERNAL(int, RSA_set0_crt_params,
                   (GO_RSA * rsa, GO_BIGNUM *dmp1, GO_BIGNUM *dmp2,
                    GO_BIGNUM *iqmp),
                   (rsa, dmp1, dmp2, iqmp))

static inline int _goboringcrypto_RSA_set0_crt_params(GO_RSA *r,
                                                      GO_BIGNUM *dmp1,
                                                      GO_BIGNUM *dmq1,
                                                      GO_BIGNUM *iqmp) {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
...
DEFINEFUNCINTERNAL(void, RSA_get0_crt_params,
                   (const GO_RSA *r, const GO_BIGNUM **dmp1,
                    const GO_BIGNUM **dmq1, const GO_BIGNUM **iqmp),
                   (r, dmp1, dmq1, iqmp))
static inline void _goboringcrypto_RSA_get0_crt_params(const GO_RSA *r,
                                                       const GO_BIGNUM **dmp1,
                                                       const GO_BIGNUM **dmq1,
...
DEFINEFUNCINTERNAL(int, RSA_set0_key,
                   ...
                   (r, n, e, d))
static inline int _goboringcrypto_RSA_set0_key(GO_RSA *r, GO_BIGNUM *n,
                                               GO_BIGNUM *e, GO_BIGNUM *d) {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
...
DEFINEFUNCINTERNAL(void, RSA_get0_factors,
                   (const GO_RSA *rsa, const GO_BIGNUM **p,
                    const GO_BIGNUM **q),
                   (rsa, p, q))
static inline void _goboringcrypto_RSA_get0_factors(const GO_RSA *rsa,
                                                    const GO_BIGNUM **p,
                                                    const GO_BIGNUM **q) {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
  if (p)
...
DEFINEFUNCINTERNAL(void, RSA_get0_key,
                   (const GO_RSA *rsa, const GO_BIGNUM **n, const GO_BIGNUM **e,
                    const GO_BIGNUM **d),
                   (rsa, n, e, d))
static inline void _goboringcrypto_RSA_get0_key(const GO_RSA *rsa,
                                                const GO_BIGNUM **n,
                                                const GO_BIGNUM **e,
                                                const GO_BIGNUM **d) {
#if OPENSSL_VERSION_NUMBER < 0x10100000L
...
int _goboringcrypto_RSA_sign_pss_mgf1(GO_RSA *, unsigned int *out_len,
                                      uint8_t *out, unsigned int max_out,
                                      const uint8_t *in, unsigned int in_len,
                                      GO_EVP_MD *md, const GO_EVP_MD *mgf1_md,
                                      int salt_len);

int _goboringcrypto_RSA_verify_pss_mgf1(GO_RSA *, const uint8_t *msg,
...
DEFINEFUNC(int, EVP_CIPHER_CTX_ctrl,
           (EVP_CIPHER_CTX * ctx, int type, int arg, void *ptr),
           (ctx, type, arg, ptr))

int _goboringcrypto_EVP_CIPHER_CTX_seal(uint8_t *out, uint8_t *nonce,
...
DEFINEFUNC(int, EVP_PKEY_set1_RSA, (GO_EVP_PKEY * arg0, GO_RSA *arg1),
           (arg0, arg1))
DEFINEFUNC(int, EVP_PKEY_set1_EC_KEY, (GO_EVP_PKEY * arg0, GO_EC_KEY *arg1),
           (arg0, arg1))
DEFINEFUNC(int, EVP_PKEY_verify,
           (EVP_PKEY_CTX * ctx, const unsigned char *sig, unsigned int siglen,
            const unsigned char *tbs, size_t tbslen),
           (ctx, sig, siglen, tbs, tbslen))

typedef EVP_PKEY_CTX GO_EVP_PKEY_CTX;

DEFINEFUNC(GO_EVP_PKEY_CTX *, EVP_PKEY_CTX_new,
           (GO_EVP_PKEY * arg0, ENGINE *arg1), (arg0, arg1))
DEFINEFUNC(GO_EVP_PKEY_CTX *, EVP_PKEY_CTX_new_id, (int arg0, ENGINE *arg1),
           (arg0, arg1))
DEFINEFUNC(void, EVP_PKEY_CTX_free, (GO_EVP_PKEY_CTX * arg0), (arg0))
DEFINEFUNC(int, EVP_PKEY_CTX_ctrl,
           (EVP_PKEY_CTX * ctx, int keytype, int optype, int cmd, int p1,
            void *p2),
...
#if OPENSSL_VERSION_NUMBER < 0x10100000L
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(
      ctx, EVP_PKEY_RSA, -1, EVP_PKEY_CTRL_RSA_PADDING, pad, NULL);
#else
  return _goboringcrypto_internal_RSA_pkey_ctx_ctrl(
      ctx, -1, EVP_PKEY_CTRL_RSA_PADDING, pad, NULL);
#endif
}

#if OPENSSL_VERSION_NUMBER < 0x30000000
static inline int
_goboringcrypto_EVP_PKEY_CTX_set0_rsa_oaep_label(GO_EVP_PKEY_CTX *ctx,
                                                 uint8_t *l, int llen) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(
      ctx, EVP_PKEY_RSA, EVP_PKEY_OP_TYPE_CRYPT, EVP_PKEY_CTRL_RSA_OAEP_LABEL,
      llen, (void *)l);
}
#else
DEFINEFUNC(int, EVP_PKEY_CTX_set0_rsa_oaep_label,
           (GO_EVP_PKEY_CTX * ctx, uint8_t *l, int llen), (ctx, l, llen))
#endif

static inline int
_goboringcrypto_EVP_PKEY_CTX_set_rsa_oaep_md(GO_EVP_PKEY_CTX *ctx,
                                             const GO_EVP_MD *md) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(
      ctx, EVP_PKEY_RSA, EVP_PKEY_OP_TYPE_CRYPT, EVP_PKEY_CTRL_RSA_OAEP_MD, 0,
      (void *)md);
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set_rsa_pss_saltlen(GO_EVP_PKEY_CTX *arg0,
                                                 int arg1) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(
      arg0, EVP_PKEY_RSA, (EVP_PKEY_OP_SIGN | EVP_PKEY_OP_VERIFY),
      EVP_PKEY_CTRL_RSA_PSS_SALTLEN, arg1, NULL);
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set_signature_md(EVP_PKEY_CTX *ctx,
                                              const EVP_MD *md) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(ctx, -1, EVP_PKEY_OP_TYPE_SIG,
                                           EVP_PKEY_CTRL_MD, 0, (void *)md);
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set_rsa_mgf1_md(GO_EVP_PKEY_CTX *ctx,
                                             const GO_EVP_MD *md) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(
      ctx, EVP_PKEY_RSA, EVP_PKEY_OP_TYPE_SIG | EVP_PKEY_OP_TYPE_CRYPT,
      EVP_PKEY_CTRL_RSA_MGF1_MD, 0, (void *)md);
}

DEFINEFUNC(int, EVP_PKEY_decrypt,
           (GO_EVP_PKEY_CTX * arg0, uint8_t *arg1, size_t *arg2,
            const uint8_t *arg3, size_t arg4),
           (arg0, arg1, arg2, arg3, arg4))
...
DEFINEFUNC(int, EVP_PKEY_derive,
           (GO_EVP_PKEY_CTX * arg0, unsigned char *arg1, size_t *arg2),
           (arg0, arg1, arg2))
#if OPENSSL_VERSION_NUMBER >= 0x30000000L
DEFINEFUNC(int, EVP_PKEY_derive_set_peer_ex,
           (GO_EVP_PKEY_CTX * arg0, GO_EVP_PKEY *arg1, int arg2),
           (arg0, arg1, arg2))
#else

#if OPENSSL_VERSION_NUMBER >= 0x10100000L
DEFINEFUNC(int, EVP_PKEY_public_check, (EVP_PKEY_CTX * arg0), (arg0))
DEFINEFUNC(int, EVP_PKEY_derive_set_peer, (EVP_PKEY_CTX *ctx, EVP_PKEY *peer), (ctx, peer))

static inline int
_goboringcrypto_EVP_PKEY_derive_set_peer_ex(GO_EVP_PKEY_CTX *ctx,
                                            GO_EVP_PKEY *key, int validate) {
...
#if OPENSSL_VERSION_NUMBER >= 0x30000000
DEFINEFUNC(int, EVP_PKEY_CTX_set_hkdf_mode, (GO_EVP_PKEY_CTX * arg0, int arg1),
           (arg0, arg1))
DEFINEFUNC(int, EVP_PKEY_CTX_set_hkdf_md,
           (GO_EVP_PKEY_CTX * arg0, const GO_EVP_MD *arg1), (arg0, arg1))
DEFINEFUNC(int, EVP_PKEY_CTX_set1_hkdf_salt,
           (GO_EVP_PKEY_CTX * arg0, unsigned char *arg1, int arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, EVP_PKEY_CTX_set1_hkdf_key,
           (GO_EVP_PKEY_CTX * arg0, unsigned char *arg1, int arg2),
           (arg0, arg1, arg2))
DEFINEFUNC(int, EVP_PKEY_CTX_add1_hkdf_info,
           (GO_EVP_PKEY_CTX * arg0, unsigned char *arg1, int arg2),
           (arg0, arg1, arg2))
...
static inline int
_goboringcrypto_EVP_PKEY_CTX_set_hkdf_md(GO_EVP_PKEY_CTX *pctx,
                                         const GO_EVP_MD *md) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(
      pctx, -1, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_HKDF_MD, 0, (void *)(md));
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set1_hkdf_salt(GO_EVP_PKEY_CTX *pctx,
                                            unsigned char *salt, int saltlen) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE,
                                           EVP_PKEY_CTRL_HKDF_SALT, saltlen,
                                           (void *)(salt));
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set1_hkdf_key(GO_EVP_PKEY_CTX *pctx,
                                           unsigned char *key, int keylen) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE,
                                           EVP_PKEY_CTRL_HKDF_KEY, keylen,
                                           (void *)(key));
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_add1_hkdf_info(GO_EVP_PKEY_CTX *pctx,
                                            unsigned char *info, int infolen) {
  return _goboringcrypto_EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE,
                                           EVP_PKEY_CTRL_HKDF_INFO, infolen,
                                           (void *)(info));
}
// This enum is introduced in OpenSSL 3.0.0 so for older versions just
// define the values.
enum {
  GO_EVP_PKEY_EC,
  GO_EVP_PKEY_KEYPAIR,
...
static inline int
_goboringcrypto_EVP_PKEY_CTX_set_hkdf_md(GO_EVP_PKEY_CTX *arg0,
                                         const GO_EVP_MD *arg1) {
  return -1;
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set1_hkdf_salt(GO_EVP_PKEY_CTX *arg0,
                                            unsigned char *arg1, int arg2) {
  return -1;
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_set1_hkdf_key(GO_EVP_PKEY_CTX *arg0,
                                           unsigned char *arg1, int arg2) {
  return -1;
}

static inline int
_goboringcrypto_EVP_PKEY_CTX_add1_hkdf_info(GO_EVP_PKEY_CTX *arg0,
                                            unsigned char *arg1, int arg2) {
  return -1;
}
#endif
...
DEFINEFUNC(int, EC_POINT_mul,
           (const GO_EC_GROUP *group, GO_EC_POINT *r, const GO_BIGNUM *n,
            const GO_EC_POINT *q, const GO_BIGNUM *m, GO_BN_CTX *ctx),
           (group, r, n, q, m, ctx))
DEFINEFUNC(int, EVP_PKEY_get_bits, (const GO_EVP_PKEY *pkey), (pkey))
DEFINEFUNC(int, EVP_PKEY_get_bn_param,
           (const GO_EVP_PKEY *pkey, const char *key_name, GO_BIGNUM **bn),
           (pkey, key_name, bn))
DEFINEFUNC(const char *, OBJ_nid2sn, (int n), (n))
DEFINEFUNC(int, EVP_PKEY_assign, (GO_EVP_PKEY * pkey, int type, void *key),
           (pkey, type, key))
DEFINEFUNC(int, EVP_PKEY_keygen_init, (GO_EVP_PKEY_CTX * ctx), (ctx))
DEFINEFUNC(int, EVP_PKEY_keygen, (GO_EVP_PKEY_CTX * ctx, GO_EVP_PKEY **ppkey),
           (ctx, ppkey))
...
static inline void _goboringcrypto_params_free(OSSL_PARAM params[]) {
  if (params == NULL)
    return;
...
DEFINEFUNC(int, EVP_PKEY_fromdata,
           (GO_EVP_PKEY_CTX * ctx, GO_EVP_PKEY **pkey, int selection,
            OSSL_PARAM params[]),
           (ctx, pkey, selection, params))
#else
// This enum is introduced in OpenSSL 3.0.0 so for older versions just
// define the values.
...
int _goboringcrypto_EVP_PKEY_fromdata_init(GO_EVP_PKEY_CTX *ctx) { return -1; }
int _goboringcrypto_EVP_PKEY_fromdata(GO_EVP_PKEY_CTX *ctx, GO_EVP_PKEY **pkey, int selection,
                      GO_OSSL_PARAM params[]) {
  return -1;
}
static inline void _goboringcrypto_params_free(GO_OSSL_PARAM params[]) {
  return;
}
#endif
...
DEFINEFUNC(size_t, EC_POINT_point2oct,
           (const GO_EC_GROUP *group, const GO_EC_POINT *p,
            point_conversion_form_t form, unsigned char *buf, size_t len,
            GO_BN_CTX *ctx),
           (group, p, form, buf, len, ctx))
DEFINEFUNC(int, EC_POINT_oct2point,
           (const GO_EC_GROUP *group, GO_EC_POINT *p, const unsigned char *buf,
            size_t len, GO_BN_CTX *ctx),
           (group, p, buf, len, ctx))

DEFINEFUNC(int, EVP_PKEY_set1_encoded_public_key,
           (GO_EVP_PKEY * pkey, const unsigned char *pub, size_t publen),
           (pkey, pub, publen))
DEFINEFUNC(size_t, EVP_PKEY_get1_encoded_public_key,
           (GO_EVP_PKEY * pkey, unsigned char **ppub), (pkey, ppub))

#if OPENSSL_VERSION_NUMBER >= 0x10100000L
DEFINEFUNC(const GO_EC_KEY *, EVP_PKEY_get0_EC_KEY, (const GO_EVP_PKEY *pkey),
           (pkey))
#else
